 ...
 */
public class RecentResults extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootView = inflater.inflate(R.layout.fragment_recent_results, container, false);
    ...
    class RetrieveFeedTask extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... urls) {
            ...
            try {
                URL url = new URL("http://cricapi.com/api/cricket/?apikey=ObGfAsu5YDeOJyNC0Lv14sOe8NA3");
        ...
        protected void onPostExecute(String response) {
            ...
            try {
                ...
                JSONArray matches = object.getJSONArray("data");
